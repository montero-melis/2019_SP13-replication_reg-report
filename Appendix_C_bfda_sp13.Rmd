...
```{r, message=FALSE}
# sim_till_aim(aim = 1)  # Outputs FALSE if there isn't any file on disk yet
# run_till_aim(aim = 1)
```
...
# But we can also load previously run results:
# 1) Lite version with 5% of the final simulations (randomly chosen)
mysims <- read_csv("data/power_simulation_results_append_lite.csv")
# 2) The full set of simulations: this is quite big and takes time to even load:
