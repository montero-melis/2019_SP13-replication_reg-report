...
We create a function that streamlines data processing, model fitting, and 
...
analyse_pipe <- function(df) {  # it expects the data frame in above format
  ...
  model_name <- paste("glmm_simul_data", deparse(substitute(df), "_full", sep = ""))
  saveRDS(bfm_binom, file = paste("data/", model_name, ".rds", sep =""))
